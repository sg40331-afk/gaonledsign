...
export default function CompanyPage() {
  return (
    <PageShell>
      ...
      <section className="container-section"><SectionTitle title="회사 연혁·보유 장비·제작시설" description="설립연도 외 세부 연혁, 장비 목록, 인증 정보는 [정보 입력 필요] 상태입니다." /><VisualPanel label="제작시설 사진 입력 필요" tall /></section>
      <ContactMapSection />
    </PageShell>
  );
}
